...
*A Resource can be anything. It's a set of data, an endpoint or anything that needs to be referenced or consumed as a part of the application.*

-   [x] What can the API return to help clients know if a request was successful?
*.status(200) or a human readable message saying that it was successful.*

-   [x] How can we partition our application into sub-applications?
*Usually by folders and URI's to differentiate components. Applications can have front end route paths, and API route paths.*
